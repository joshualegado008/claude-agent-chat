        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <Image
                src="/images/claude-chorus-logo-512.png"
                alt="Claude Chorus"
                width={48}
                height={48}
                className="w-12 h-12"
              />
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-chorus-accent to-chorus-primary bg-clip-text text-transparent">
                  Claude Chorus
                </h1>
                <p className="text-slate-400 mt-1">
                  Watch AI agents harmonize in real-time
                </p>
              </div>
            </div>
            ...
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-chorus-secondary to-chorus-primary text-white rounded-lg font-medium hover:from-chorus-primary hover:to-chorus-accent transition-all duration-200 transform hover:scale-105 shadow-lg"
            >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-chorus-primary focus:border-transparent"
            />
            {searchQuery && (
              <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-slate-800 rounded-xl shadow-lg p-6 border border-slate-700">
            <div className="flex items-center justify-between">
              ...
              <MessageSquare className="w-12 h-12 text-chorus-primary" />
            </div>
          </div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-3 text-sm text-slate-400 mb-2">
                            <span className="flex items-center space-x-1">
                              <span className="text-chorus-primary">Match:</span>
                              <span className="font-medium text-chorus-accent">
          ...
          {!isSearchMode && (
            <>
              ...
              {data && data.conversations.length === 0 && (
                <div className="p-12 text-center text-slate-400">
                  <div className="mx-auto mb-4 w-16 h-16 flex items-center justify-center opacity-50">
                    <Image
